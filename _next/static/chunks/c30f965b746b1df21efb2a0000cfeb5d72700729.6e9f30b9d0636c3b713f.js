  ...
  [2],
  {
    ...
    QmWs: function(t, e, r) {
      ...
      function w(t, e, r) {
        ...
        var a = !/(^javascript)/.test(t) && t.match(d),
          c = m.test(t),
          l = "";
        a &&
          (y.test(a[1]) || ((l = a[1].toLowerCase()), (t = "" + a[2] + a[3])),
          a[2] ||
            ((c = !1),
            y.test(a[1]) ? ((l = a[1]), (t = "" + a[3])) : (t = "//" + a[3])),
    ...
    elyg: function(t, e, r) {
      ...
      var u = r("QmWs"),
        ...
        y = "";
      function v(t) {
        return 0 !== t.indexOf(y) ? y + t : t;
      }
      function d(t) {
        return 0 === t.indexOf(y) ? t.substr(y.length) || "/" : t;
      }
      function m(t) {
        return t.replace(/\/$/, "") || "/";
      }
      (e.addBasePath = v), (e.delBasePath = d);
      var g = function(t) {
        ...
        function t(e, r, n, o) {
          ...
          a(this, t),
            ...
            (this._getStaticData = function(t) {
              var e = g(u.parse(t).pathname);
              return i.sdc[e]
                ? Promise.resolve(i.sdc[e])
                : b(e, null, i.isSsr, function(t) {
                    return (i.sdc[e] = t);
                  });
            }),
                ...
                value: function(e, r, n, o) {
                  ...
                  return new Promise(function(i, c) {
                    ...
                    var s =
                      ...
                      y = "object" === typeof n ? l.formatWithValidation(n) : n;
                    if (
                      ((s = v(s)),
                      (y = v(y)),
                      a.abortComponentLoad(y),
                      !o._h && a.onlyAHashChange(y))
                    )
                      return (
                        (a.asPath = y),
                        t.events.emit("hashChangeStart", y),
                        a.changeState(e, s, y, o),
                        a.scrollToHash(y),
                        t.events.emit("hashChangeComplete", y),
                        i(!0)
                      );
                    var d = u.parse(s, !0),
                      g = d.pathname,
                      ...
                      w = d.protocol;
                    if (!g || w) return i(!1);
                    a.urlIsNew(y) || (e = "replaceState");
                    var _ = m(g),
                      x = o.shallow,
                      S = void 0 !== x && x;
                    if (f.isDynamicRoute(_)) {
                      var O = u.parse(y).pathname,
                        P = h.getRouteRegex(_),
                    ...
                    t.events.emit("routeChangeStart", y),
                      a.getRouteInfo(_, g, b, y, S).then(function(r) {
                        var n = r.error;
                        if (n && n.cancelled) return i(!1);
                        if (
                          (t.events.emit("beforeHistoryChange", y),
                          a.changeState(e, s, y, o),
                          a.set(_, g, b, y, r),
                          n)
                        )
                          throw (t.events.emit("routeChangeError", n, y), n);
                        return t.events.emit("routeChangeComplete", y), i(!0);
                      }, c);
                  });
                }
              },
                ...
                value: function(t) {
                  ...
                  return new Promise(function(o, a) {
                    ...
                    if (c && !s) {
                      ...
                      var l = d(m(c));
                      Promise.all([
                        e.pageLoader.prefetchData(t, d(r)),
      ...
      (e.default = w), (w.events = s.default());
    },
    "g/15": function(t, e, r) {
      "use strict";
      var n = r("o0o1");
    ...
    nOHt: function(t, e, r) {
      ...
      Object.defineProperty(p, "events", { get: () => s.default.events }),
        h.forEach(function(t) {
          Object.defineProperty(p, t, { get: () => v()[t] });
        }),
        y.forEach(function(t) {
          p[t] = function() {
            var e = v();
