  ...
  [3],
  {
    ...
    IKlv: function(e, t, r) {
      ...
      var d = p(r("pVnL")),
        ...
        R = r("/jkW"),
        S = r("bGXG");
      "finally" in Promise.prototype || (Promise.prototype.finally = r("Z577"));
      ...
      var T = C.props,
        ...
        O = M || "";
      (r.p = O + "/_next/"),
        b.setConfig({ serverRuntimeConfig: {}, publicRuntimeConfig: D || {} });
      var q = (0, _.getURL)(),
        B = new E.default(A, O),
        H = function(e) {
          var t = s(e, 2),
              ...
              switch ((t.prev = t.next)) {
                ...
                case 9:
                  return (
                    ...
                    (t.t0 = t.catch(4)),
                    (t.next = 13),
                    n.awrap(K((0, d.default)({}, e, { err: t.t0 })))
                  );
                case 13:
                case "end":
                  return t.stop();
          ...
          function(c) {
            for (;;)
              switch ((c.prev = c.next)) {
                ...
                case 15:
                  return (
                    (c.next = 17), n.awrap((0, _.loadGetInitialProps)(t, i))
                  );
                case 17:
                  c.t0 = c.sent;
                case 18:
            ...
            for (;;)
              switch ((c.prev = c.next)) {
                ...
                case 25:
                  ...
                  return (c.next = 28), n.awrap(window.__NEXT_PRELOADREADY(j));
                case 28:
                  return (
                    (t.router = F = (0, y.createRouter)(I, N, q, {
                      initialProps: T,
                      pageLoader: B,
                      App: Y,
                      Component: X,
                    ...
                    V({ App: Y, Component: X, props: T, err: i }),
                    c.abrupt("return", z)
                  );
                case 34:
                  c.next = 36;
      ...
      function ee(e, t) {
        if (
          ...
          Q
            ? (h.default.hydrate(e, t, te), (Q = !1))
            : h.default.render(e, t, re),
          J && _.ST)
        )
          try {
            (0, S.observeLayoutShift)(J),
              (0, S.observeLargestContentfulPaint)(J),
              (0, S.observePaint)(J);
          } catch (r) {
      ...
      function te() {
        _.ST &&
          ...
          J &&
            (performance.getEntriesByName("Next.js-hydration").forEach(J),
      ...
      function oe(e) {
        ...
        return m.default.createElement(
          ...
          {
            fn: function(e) {
              return K({ App: Y, err: e }).catch(function(e) {
          ...
          m.default.createElement(
            ...
            { value: (0, y.makePublicRouterInstance)(F) },
            m.default.createElement(
      ...
      var ae = function(e) {
        return function(t) {
          var r = (0, d.default)({}, t, { Component: X, err: k, router: F });
          return m.default.createElement(
            oe,
            null,
              ...
              switch ((h.prev = h.next)) {
                case 0:
                  ...
                  return (
                    ...
                    (h.next = 7),
                    n.awrap((0, _.loadGetInitialProps)(t, l))
                  );
                case 7:
                  o = h.sent;
                case 8:
            ...
            },
            {
              ...
              value: function(e, t) {
                var r,
                  ...
                  h = m(u),
                  v = (0, c.isDynamicRoute)(h);
                if (v) {
                  var y = (0, f.getRouteRegex)(h),
                    g = y.groups,
                    _ = (0, s.getRouteMatcher)(y)(d) || p;
                  (r = h),
              ...
              value: function(e, t) {
                ...
                return Promise.all(
                  document.querySelector(
                    ...
                    ? []
                    : [
                        h(n, d, n.match(/\.css$/) ? "style" : "script"),
                        !t &&
